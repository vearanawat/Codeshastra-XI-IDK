...
export default function ForgotPassword() {
  ...
  const penguinMessages = [
    "Forgot your password? Let me help!",
      ...
      <div className="w-full md:w-1/2 bg-white flex items-center justify-center p-6">
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Forgot your password?</p>
          </motion.div>

          <motion.div variants={itemVariants} className="text-center md:hidden">
          ...
          {isSubmitted ? (
            <motion.div
              className="rounded-md bg-green-50 dark:bg-green-900/20 p-6 text-center"
            ...
            >
              ...
              <h3 className="mt-3 text-lg font-medium text-green-800 dark:text-green-300">Reset link sent!</h3>
              <div className="mt-2 text-sm text-green-700 dark:text-green-400">
                <p>We've sent a password reset link to <span className="font-semibold">{email}</span>.</p>
              ...
              <motion.div variants={itemVariants}>
                <motion.button
                  ...
                  className={`group relative w-full flex justify-center py-3 px-4 border border-transparent 
                            text-sm font-semibold rounded-lg text-white bg-blue-600 
